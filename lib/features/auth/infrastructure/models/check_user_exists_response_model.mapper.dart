...
class CheckUserExistsResponseModelMapper
  ...
  static CheckUserExistsResponseModelMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = CheckUserExistsResponseModelMapper._());
    }
    return _instance!;
  }
  ...
  static const Field<CheckUserExistsResponseModel, bool> _f$exists =
      Field('exists', _$exists);
...
mixin CheckUserExistsResponseModelMappable {
  ...
  CheckUserExistsResponseModelCopyWith<CheckUserExistsResponseModel,
          CheckUserExistsResponseModel, CheckUserExistsResponseModel>
      get copyWith => _CheckUserExistsResponseModelCopyWithImpl<
              CheckUserExistsResponseModel, CheckUserExistsResponseModel>(
  ...
  bool operator ==(Object other) {
    return CheckUserExistsResponseModelMapper.ensureInitialized()
        .equalsValue(this as CheckUserExistsResponseModel, other);
  }

  @override
  int get hashCode {
    return CheckUserExistsResponseModelMapper.ensureInitialized()
        .hashValue(this as CheckUserExistsResponseModel);
  }
}
...
extension CheckUserExistsResponseModelValueCopy<$R, $Out>
  ...
  CheckUserExistsResponseModelCopyWith<$R, CheckUserExistsResponseModel, $Out>
      get $asCheckUserExistsResponseModel => $base.as((v, t, t2) =>
          _CheckUserExistsResponseModelCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _CheckUserExistsResponseModelCopyWithImpl<$R, $Out>
    ...
    implements
        CheckUserExistsResponseModelCopyWith<$R, CheckUserExistsResponseModel,
            $Out> {
  ...
  CheckUserExistsResponseModelCopyWith<$R2, CheckUserExistsResponseModel, $Out2>
      $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
          _CheckUserExistsResponseModelCopyWithImpl<$R2, $Out2>(
              $value, $cast, t);
}
