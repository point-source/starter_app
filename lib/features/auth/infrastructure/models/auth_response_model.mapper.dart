...
class AuthResponseModelMapper extends ClassMapperBase<AuthResponseModel> {
  ...
  static const Field<AuthResponseModel, UserModel> _f$user = Field(
    'user',
    _$user,
  );
  static AuthTokensModel _$tokens(AuthResponseModel v) => v.tokens;
  static const Field<AuthResponseModel, AuthTokensModel> _f$tokens = Field(
    'tokens',
    _$tokens,
  );
...
class _AuthResponseModelCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({UserModel? user, AuthTokensModel? tokens}) => $apply(
    FieldCopyWithData({
