...
class AuthWsEventModelMapper extends ClassMapperBase<AuthWsEventModel> {
  ...
  static const Field<AuthWsEventModel, String> _f$event = Field(
    'event',
    _$event,
  );
  static UserModel? _$data(AuthWsEventModel v) => v.data;
  static const Field<AuthWsEventModel, UserModel> _f$data = Field(
    'data',
    _$data,
    opt: true,
  );
  static DateTime? _$timestamp(AuthWsEventModel v) => v.timestamp;
  static const Field<AuthWsEventModel, DateTime> _f$timestamp = Field(
    'timestamp',
    _$timestamp,
    opt: true,
  );
...
mixin AuthWsEventModelMappable {
  ...
  get copyWith =>
      _AuthWsEventModelCopyWithImpl<AuthWsEventModel, AuthWsEventModel>(
        this as AuthWsEventModel,
        $identity,
        $identity,
      );
  @override
  String toString() {
    return AuthWsEventModelMapper.ensureInitialized().stringifyValue(
      this as AuthWsEventModel,
    );
  }
  ...
  bool operator ==(Object other) {
    return AuthWsEventModelMapper.ensureInitialized().equalsValue(
      this as AuthWsEventModel,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AuthWsEventModelMapper.ensureInitialized().hashValue(
      this as AuthWsEventModel,
    );
  }
}
...
extension AuthWsEventModelValueCopy<$R, $Out>
  ...
  get $asAuthWsEventModel =>
      $base.as((v, t, t2) => _AuthWsEventModelCopyWithImpl<$R, $Out>(v, t, t2));
}
